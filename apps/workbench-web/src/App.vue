...
onBeforeUnmount(() => { socket?.close(); if (reconnectTimer !== null) window.clearTimeout(reconnectTimer); if (dashboardTimer !== null) window.clearInterval(dashboardTimer) })
</script>
